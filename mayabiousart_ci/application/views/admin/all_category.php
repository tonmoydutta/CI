...
<div class="content-wrapper" style="min-height: ">
    ...
    <?php if(!empty($category_susscess)){?>
     ...
     <?php if(!empty($delete_news_msg)){?>
      ...
      <ol class="breadcrumb">
        <li><a href="<?=base_url();?>add_video_category" style="padding:3px 13px 3px; background-color:#00b33c; color: #fff; font-weight: bold;">Add New</a></li>
...
<?php
$i=1;
foreach($category_show->result() as $row){
?>
                ...
                <tr id="clients_tr_<?=$row->slno;?>">
                  ...
                  <td><a href="<?=base_url();?>edit_video_category/<?=$row->slno;?>">Edit</a> | <a href="#" onclick="delete_category(<?=$row->slno;?>);">Delete</a></td>
