    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
           <?php foreach($edit_media->result() as $row){ ?>
              <form method="post" enctype="multipart/form-data" action="<?=base_url();?>edit_media_code">
                <div class="box box-info">
                
                <div class="box-header">
                  <label for="exampleInputEmail1">Media Title</label>
                  <input type="text" class="form-control" name="edit_media_title" placeholder="Enter Title" value="<?=$row->title;?>">
                </div>
           ...
           <div class="box-header">
             ...
             <div class="box-header">
                  ...
                  <input type="file" class="form-control" name="edit_media_image">
                  <?php 
             if($row->image!="")
            {
                  ?>
              ...
              <input type="hidden" name="edit_media_slno" value="<?=$row->slno;?>">
