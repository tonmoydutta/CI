...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit Creative Approach Content
        <small></small>
      </h1>
      <!--<ol class="breadcrumb">
    ...
    <?php
           foreach($edit_creative_contact_content->result() as $row){

    ?>       

              <form action="<?=base_url();?>update_approach_content" method="post">
                <div class="box box-info">
                <div class="box-header">
                  <label for="exampleInputEmail1">Title</label>
                  <input type="text" class="form-control" name="approach_title"  placeholder="Enter Title" value="<?=$row->title;?>">
                </div>
      ...
      <input type="hidden" name="approach_slno" value="<?=$row->slno;?>">
