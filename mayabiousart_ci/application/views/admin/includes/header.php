...
<head>
  ...
  <title>Mayabious Art | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url();?>dashboard" class="logo">
      ...
      <span class="logo-mini"><img src="<?= base_url();?>assets/admin/img/mayabiousLogo-small.png"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?= base_url();?>assets/admin/img/mayabiousLogo.png"></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php if($this->session->has_userdata('sessionid')){?> <?php echo $_SESSION['sessionid']['name'];?> <?php }?>
